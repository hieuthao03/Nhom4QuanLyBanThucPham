...
namespace Nhom4QuanLyBanThucPham.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class Nhom4QuanLyBanThucPhamModule : ModuleBase {
    public Nhom4QuanLyBanThucPhamModule() {
		// 
		// Nhom4QuanLyBanThucPhamModule
		// 
